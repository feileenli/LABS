 ...
 * Just pass the URL for an image to the showImages() method.
 * 
...
public class PictureViewer {
	...
	/* Feel free to change these to resize the window */
	private static final int WINDOW_HEIGHT = 540;
	private static final int WINDOW_WIDTH = 960;
	
	/* Don't display pictures smaller than these dimensions */
	...
	public static void showImage(String imageName) {
		try {
			...
			thePanel.repaint();
		} catch (Exception e) {     // Seriously... DON'T EVER DO THIS!
			return;
		}
	}
